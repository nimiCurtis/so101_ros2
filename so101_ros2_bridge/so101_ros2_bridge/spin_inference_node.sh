...
# Before running the node, ensure PYTHONPATH prioritizes conda env
export PYTHONPATH="/home/anton/miniconda3/envs/lerobot_ros2/lib/python3.10/site-packages:$PYTHONPATH"
